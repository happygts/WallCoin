...
export const ApiNameSpace = {
    ...
    GET_MYCOINS: 'GET_MYCOINS',
    GET_MYCOINS_FAVORITES: 'GET_MYCOINS_FAVORITES',
    CREATE_MY_COIN: 'CREATE_MY_COIN',
    DELTE_MY_COIN: 'DELTE_MY_COIN',
    MODIFY_MY_COIN: 'MODIFY_MY_COIN'
}